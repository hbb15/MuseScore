...
//      { Sid::figuredBassFontSize,     "figuredBassFontSize",     QVariant(8.0) },
      ...
      { Sid::numericHeightDisplacement,     "numericHeightDisplacement",     0.3 },
      { Sid::numericDistanceOctave,         "numericDistanceOctave",         0.35 },
      { Sid::numericHeigthLine,             "numericHeigthLine",             -0.21},
      { Sid::numericOffsetLine,             "numericOffsetLine",             -2.0},
      { Sid::numericDistanceBetweenLines,   "numericDistanceBetweenLines",   0.16 },
      { Sid::numericWideLine,               "numericWideLine",               0.7 },
      { Sid::numericThickLine,              "numericThickLine",              0.06 },
      { Sid::numericSizeSignSharp,          "numericSizeSignSharp",          1.07 },
      { Sid::numericSizeSignFlat,           "numericSizeSignFlat",           1.0 },
      { Sid::numericDistanceSignSharp,      "numericDistanceSignSharp",      0.55 },
      { Sid::numericDistanceSignFlat,       "numericDistanceSignFlat",       0.40 },
      { Sid::numericHeigthSignSharp,        "numericHeigthSignSharp",        0.28 },
      { Sid::numericHeigthSignFlat,         "numericHeigthSignFlat",         0.27 },
