...
//      { Sid::figuredBassFontSize,     "figuredBassFontSize",     QVariant(8.0) },
      ...
      { Sid::numericDistanceSignSharp,      "numericDistanceSignSharp",      1.06 },
      { Sid::numericDistanceSignFlat,       "numericDistanceSignFlat",       0.85 },
      { Sid::numericHeigthSignSharp,        "numericHeigthSignSharp",        0.4 },
      { Sid::numericHeigthSignFlat,         "numericHeigthSignFlat",         0.43 },
      { Sid::numericFont,                   "numericFont",                   "FreeSerif" },
      { Sid::numericSlurEckenform,          "numericSlurEckenform",          1.0 },
