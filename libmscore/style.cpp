...
//      { Sid::figuredBassFontSize,     "figuredBassFontSize",     QVariant(8.0) },
      ...
      { Sid::numericSizeSignSharp,          "numericSizeSignSharp",          1.21 },
      { Sid::numericSizeSignFlat,           "numericSizeSignFlat",           0.9 },
      { Sid::numericDistanceSignSharp,      "numericDistanceSignSharp",      1.09 },
      { Sid::numericDistanceSignFlat,       "numericDistanceSignFlat",       0.61 },
      { Sid::numericHeigthSignSharp,        "numericHeigthSignSharp",        0.51 },
      { Sid::numericHeigthSignFlat,         "numericHeigthSignFlat",         0.56 },
      ...
      { Sid::numericSlurHeigth,             "numericSlurHeigth",             0.3 },
      { Sid::numericSlurUberhang,           "numericSlurUberhang",           -0.08 },
      { Sid::numericSlurShift,              "numericSlurShift",              0.31 },
