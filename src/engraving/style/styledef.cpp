...
const std::array<StyleDef::StyleValue, size_t(Sid::STYLES)> StyleDef::styleValues { {
    ...
    { Sid::cipherHeightDisplacement,     "cipherHeightDisplacement",     0.45 },
    { Sid::cipherDistanceOctave,         "cipherDistanceOctave",         0.5 },
    { Sid::cipherHeigthLine,             "cipherHeigthLine",             0.14 },
    { Sid::cipherOffsetLine,             "cipherOffsetLine",             0.0 },
    { Sid::cipherDistanceBetweenLines,   "cipherDistanceBetweenLines",   0.21 },
    { Sid::cipherWideLine,               "cipherWideLine",               0.7 },
    { Sid::cipherThickLine,              "cipherThickLine",              0.07 },
    { Sid::cipherSizeSignSharp,          "cipherSizeSignSharp",          1.07 },
    { Sid::cipherSizeSignFlat,           "cipherSizeSignFlat",           1.0 },
    { Sid::cipherDistanceSignSharp,      "cipherDistanceSignSharp",      0.7 },
    { Sid::cipherDistanceSignFlat,       "cipherDistanceSignFlat",       0.42 },
    ...
    { Sid::cipherSlurUberhang,           "cipherSlurUberhang",           -0.08 },
    { Sid::cipherSlurShift,              "cipherSlurShift",              0.0 },
    { Sid::cipherLedgerlineThick,        "cipherLedgerlineThick",        0.06 },
    { Sid::cipherLedgerlineLength,       "cipherLedgerlineLength",       1.2 },
    { Sid::cipherLedgerlineShift,        "cipherLedgerlineShift",        0.0 },
    { Sid::cipherMinStaffSpread,         "cipherMinStaffSpread",         Spatium(3.5) },
    { Sid::cipherMinSystemSpread,        "cipherMinSystemSpread",        Spatium(3.5) },
    { Sid::cipherTimeSigSize,            "cipherTimeSigSize",            0.95 },
    { Sid::cipherTimeSigDistance,        "cipherTimeSigDistance",        0.15 },
    { Sid::cipherTimeSigLineThick,       "cipherTimeSigLineThick",       0.09 },
    { Sid::cipherTimeSigLineSize,        "cipherTimeSigLineSize",        1.0 },
    { Sid::cipherTimeSigFont,            "cipherTimeSigFont",            "Cipher" },
    { Sid::cipherKeySigFont,             "cipherKeySigFont",             "Cipher" },
    { Sid::cipherKeySigSize,             "cipherKeySigSize",             0.95 },
    { Sid::cipherKeySigHorizontalShift,  "cipherKeySigHorizontalShift",  1.0 },
    { Sid::cipherKeySigHigth,            "cipherKeySigHigth",            2.5 },
    { Sid::cipherKeysigNoteDistancLeft,  "cipherKeysigNoteDistancLeft",  0.5 },
    { Sid::cipherKeysigNoteDistancReigth,"cipherKeysigNoteDistancReigth",1.0 },
    { Sid::cipherBarlineLength,          "cipherBarlineLength",          1.0 },
    { Sid::cipherFontSize,               "cipherFontSize",               12.0 },
    { Sid::cipherRestDistanc,            "cipherRestDistanc",            1.0 },
    { Sid::cipherNoteDistanc,            "cipherNoteDistanc",            1.0 },
    { Sid::cipherAccidentalFont,         "cipherAccidentalFont",         "Cipher" },
    { Sid::cipherTupletSlurEcke,         "cipherTupletSlurEcke",         0.1 },
    { Sid::cipherTupletSlurhigth,        "cipherTupletSlurhigth",        0.8 },
    { Sid::cipherTupletSlurdistans,      "cipherTupletSlurdistans",      0.0 },
    { Sid::cipherTupletSlurshift,        "cipherTupletSlurshift",        0.0 },
    { Sid::cipherTupletSluruberhang,     "cipherTupletSluruberhang",     0.0 },
    { Sid::cipherTupletNummerHigth,      "cipherTupletNummerHigth",      0.0 },
    { Sid::cipherTupletSlurThickness,    "cipherTupletSlurThickness",    1.3 },
    { Sid::cipherTupletNummerFontSize,   "cipherTupletNummerFontSize",   0.6 },
    { Sid::cipherTupletNummerFont,       "cipherTupletNummerFont",       "Cipher" }
